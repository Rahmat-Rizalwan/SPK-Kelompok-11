...
public class GejalaEditActivity extends AppCompatActivity {
    ...
    private static final String url = "https://app.irmanfrdev.com/sp_rambutan/get_gejala.php";
    private static final String url_update = "https://app.irmanfrdev.com/sp_rambutan/update_gejala.php";
    private static final String url_delete = "https://app.irmanfrdev.com/sp_rambutan/delete_gejala.php";
