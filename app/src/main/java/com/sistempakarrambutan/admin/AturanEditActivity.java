...
public class AturanEditActivity extends AppCompatActivity {
    ...
    private static final String url = "https://app.irmanfrdev.com/sp_rambutan/get_daftar_gejala.php";
    private static final String url_update = "https://app.irmanfrdev.com/sp_rambutan/update_aturan.php";
