package com.sistempakarrambutan.admin;
...
import com.sistempakarrambutan.MySingleton;
...
public class PenyakitEditActivity extends AppCompatActivity {
    ...
    private static final String url = "https://app.irmanfrdev.com/sp_rambutan/get_penyakit.php";
    private static final String url_update = "https://app.irmanfrdev.com/sp_rambutan/update_penyakit.php";
    private static final String url_delete = "https://app.irmanfrdev.com/sp_rambutan/delete_penyakit.php";
